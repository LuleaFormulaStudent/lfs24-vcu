...
export default class ADS1115 {
    ...
    private async read(mux: number, gain: ADS1x15_CONFIG_GAIN, data_rate: ADS1115_CONFIG_DR, mode: number): Promise<number> {
        if (this.i2c_device) {
            /*
            ...
            */
            ...
            this.i2c_device.readI2cBlockSync(this.adress, this.ADS1x15_POINTER_CONVERSION, 2, buffer)
